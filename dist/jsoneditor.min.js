...
var b=this.getElementEditor(0,!0);if(this.item_default=b.getDefault(),this.width=b.getNumColumns()+2,this.options.compact)this.panel=document.createElement("div"),this.panel.style.overflow="auto",this.container.appendChild(this.panel);else{if(this.title=this.theme.getHeader(this.getTitle()),this.jsoneditor.options.selectable_fields){var c=document.createElement("label"),d=document.createElement("input");d.type="checkbox",d.className="actual-field",c.appendChild(d),this.title.insertBefore(c,this.title.childNodes[0])}this.header=this.title,this.container.appendChild(this.title),this.title_controls=this.theme.getHeaderButtonHolder(),this.title_controls.style.marginTop="-5px",this.title.insertBefore(this.title_controls,this.title.childNodes[0]),this.schema.description&&(this.description=this.theme.getDescription(this.schema.description),this.container.appendChild(this.description)),this.panel=this.theme.getIndentedPanel(),this.panel.style.overflow="auto",this.container.appendChild(this.panel),this.error_holder=document.createElement("div"),this.panel.appendChild(this.error_holder)}if(this.panel.appendChild(this.table),this.controls=this.theme.getButtonHolder(),this.panel.appendChild(this.controls),this.item_has_child_editors)for(var e=b.getChildEditors(),f=b.property_order||Object.keys(e),g=0;g<f.length;g++){var h=a.theme.getTableHeaderCell(e[f[g]].getTitle());e[f[g]].options.hidden&&(h.style.display="none"),a.header_row.appendChild(h)}else a.header_row.appendChild(a.theme.getTableHeaderCell(this.item_title));b.destroy(),this.row_holder.innerHTML="",
// Row Controls column
